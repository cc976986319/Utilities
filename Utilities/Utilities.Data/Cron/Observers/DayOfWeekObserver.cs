...
namespace Utilities.Data.Cron.Observers
{
    ...
    ///                              │
    ///                              │ 
    ///                              └ 周(0 - 7) (0 or 7 is Sun)     【允许的通配符[, -* / L #]】
    /// </remarks>
    public class DayOfWeekObserver : Base.Observer
    {
        /// <summary>
        /// 实例化 周天 观察者
        /// </summary>
        /// <param name="resolve">cron解析器</param>
        public DayOfWeekObserver(CronResolve resolve)
        {
        ...
        {
            string _cron = GetTargetCronSlice(TimeFormat.DayOfWeek, cron);
            Tuple<bool, string, dynamic> value = PipelineController.DayOfWeekDisposePipeline(_cron);
            if (value.Item1)
